...
void setup()
{
  ...
  Serial.print("\nStarting Async_ConfigOnStartup with DoubleResetDetect using " + String(FS_Name));
  ...
  ESPAsync_WiFiManager ESPAsync_wifiManager(&webServer, &dnsServer, "ConfigOnStartup");
