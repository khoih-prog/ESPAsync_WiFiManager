# Async_ESP32_FSWebServer Example
...
1. For example, you already downloaded data files from (https://github.com/khoih-prog/ESPAsync_WiFiManager/tree/master/examples/Async_ESP32_FSWebServer/data) to a local folder, for example:
