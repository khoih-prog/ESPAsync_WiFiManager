...
1. For example, you already downloaded data files from (https://github.com/khoih-prog/ESPAsync_WiFiManager/tree/master/examples/Async_ESP_FSWebServer_DRD/data) to a local folder, for example:
